...
public class RemoveInkAnnotation {

	/**
	 * Confirma a exclusao e remove uma anotacao em tinta.
	 * 
	 * @param context
	 * @param drawList
	 * @param notesPath
	 ...
	 */
	public static void removeDialog(final Context context, final List<DrawAnnotationInfo> drawList, final String notesPath, final String videoName,
			final String author, final Dialog parent, final Button bNavigation, final AnnotationContainer container,
			final AuthoringOperators authoringOperators) {
		...
		bOk.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				for (DrawAnnotationInfo drawAnnotation : drawList) {
					authoringOperators.removeInkAnnotation(drawAnnotation, notesPath, videoName, author, container);
				}
				dialog.dismiss();
				parent.dismiss();
