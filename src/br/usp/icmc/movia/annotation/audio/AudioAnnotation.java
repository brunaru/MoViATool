...
public class AudioAnnotation {
	...
	@ElementList
	private List<AudioAnnotationInfo> annotationList = new ArrayList<AudioAnnotationInfo>();
	
	@ElementList
	private List<AuthorContext> authorsCtxList = new ArrayList<AuthorContext>();

	public List<AudioAnnotationInfo> getAnnotationList() {
		return annotationList;
	}

	public void setAnnotationList(List<AudioAnnotationInfo> annotationList) {
