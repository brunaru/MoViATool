...
public class DrawAnnotation {
	...
	@ElementList
	private List<DrawAnnotationInfo> annotationList = new ArrayList<DrawAnnotationInfo>();
	
	@ElementList
	private List<AuthorContext> authorsCtxList = new ArrayList<AuthorContext>();

	public List<DrawAnnotationInfo> getAnnotationList() {
		return annotationList;
	}

	public void setAnnotationList(List<DrawAnnotationInfo> annotationList) {
